...
% CutTransients.Hit_Transients is organized as such
    % CutTransients.Hit_Transients(neuron,event#){8 second window of timestamp based transients}
...
% save the workspace to be able to easily plot in the future 
save('Ca2exampleAllCellsAvg')
