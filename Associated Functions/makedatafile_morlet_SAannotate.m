...
% Set your variables to constants 
...
% My lack of understanding here is definitely conceptually not
% understanding the Morelet, and phase extraction...

% Do some reading and come back to it

phase_frequency = mean(phase); %why is this the phase_frequency?
power_frequency = mean(power);

% Extract phase and power from wavelet convolution
time = -1:1/signal_data.srate:1; % 2 seconds vector at a 1/sampling rate rate. 
% Not sure how this is time? Also could this window be altered?
