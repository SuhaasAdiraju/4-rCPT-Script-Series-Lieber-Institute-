%% PAC Demo (for uni-regional coupling)

addpath ('Z:\Suhaas A\Analysis things\HH_PAC_FunctionFiles');
addpath ('Z:\Circuits projects (CPT)\CPT Recording Data\EXAMPLE SCRIPTS SAMPLE DATA');
load ('S3Good_1700S.mat');

        %Load LFP data
            % load('plot_lfp.mat');
    
% Assess what you have and change variables names as needed based on the
% variable names in the code below; As well as parse given what you want to
% look at
