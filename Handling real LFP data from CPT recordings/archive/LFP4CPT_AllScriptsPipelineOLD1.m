...
if (isempty(stageCell)==1)
        ...
        stageCell = inputdlg(sprintf('What stage do you need to start from?\n\n1- for the beginning (.edf --> average response window),\n\n2- for straight to creating a structure with Tstamps,\n\n3- for straight to slicing based on Tstamps\n\n4- for straight to single-subject Avg response window\n\n5- for straight to basic analysis of data (Signal assessment; Phase-amplitude coupling)\n\n6- for straight to averaging across subjects\n'))
end
